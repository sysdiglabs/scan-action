...
```yaml
    ...
    - name: Scan infrastructure
      ...
      with:
        sysdig-secure-token: ${{ secrets.SYSDIG_SECURE_TOKEN }}
        cli-scanner-version: 1.29.0 # newest-version-marker — DO NOT REMOVE; auto-updated by `just update-cli-scanner`
        mode: iac
